...
### Author: Alfred Homere NGANDAM MFONDOUM 
### Date: May, 2016
---
# Context

This is the first project for fifth course of the Data Analyst especialiazation intitled "Reproducible Research". The purpose of the project has been to answer some questions using data collected from a FitBit.

# Purpose 

The purpose of this project is divided in three orders as follow:
